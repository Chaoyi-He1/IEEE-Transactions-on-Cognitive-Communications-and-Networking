...
Encoder $\rightarrow$ CNN, direct label regression
  & \textit{removed} & 0.8382 & 0.9237 & 5.7\% & 60 \ul{ms} \\
\hline

Proposed (20 samples, ensemble mean)
  & full & 0.8185 & 0.9174 & 6.0\% & 516 \ul{ms} \\
\hline

Proposed, state-conditioned diffusion
  & full & 0.8301 & 0.9233 & 2.9\% & 526 \ul{ms} \\
\hline

\textbf{Proposed $\oplus$ sensed state (fusion)}
  & \textbf{full} & \textbf{0.8844} & \textbf{0.9473} & \textbf{12.8\%} & \textbf{526 \ul{ms}} \\
\hline
