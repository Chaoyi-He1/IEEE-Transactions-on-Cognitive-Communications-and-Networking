...
pipeline. Table~\ref{tab:ota} reports the results. Fig.~\ref{fig:occupancy_measured} 
shows the resulting prediction on 512 consecutive received packets for the 
fusion configuration; its errors are confined to the prediction window immediately 
following each occupancy change.
