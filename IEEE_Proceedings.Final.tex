...
sub-blocks $\times$ 48 OFDM-symbol intervals (614.4~$\mu$s, excluding guard intervals),
...
resulting in inefficiencies. In contrast, the bottom section shows the proposed system,
...
conditioned on $z_t$; the temporal-to-frequency classifier maps each
...
Fig.~\ref{fig:Figure_Operation_vacancy.pdf} for anyone considering deployment.
...
place the architecture against representative
...
\bibitem{FCC2015CBRS} Federal Communications Commission, ``Amendment of the Commission's rules with regard to commercial operations in the 3550--3650 MHz band: Report and order and second further notice of proposed rulemaking,'' GN Docket No.~12-354, FCC 15-47, Apr. 2015.

\bibitem{NSS2023} National Telecommunications and Information Administration, ``National spectrum strategy,'' U.S. Dept.\ of Commerce, Nov. 2023.
